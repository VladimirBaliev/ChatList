"""
Runtime hook для исправления путей к DLL PyQt5.
Добавляет путь к DLL Qt в PATH перед импортом PyQt5.
"""
import os
import sys
...
if getattr(sys, 'frozen', False):
    ...
    # 2. PyQt5/Qt5/bin (оригинальный путь)
    qt_bin_path = os.path.join(base_path, '_internal', 'PyQt5', 'Qt5', 'bin')
